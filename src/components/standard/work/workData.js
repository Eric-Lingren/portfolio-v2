...
const projects = [
    ...
    },
    {
        ...
        "detailsDescription" : "This project is custom build chrome extension that when clicked loads an iframe in the users current browser rendering a fully interactive react app with dog gifs and images",
