...
const projects = [
    ...
    },
    {
        ...
        "detailsDescription" : "This site takes an HTML forex trading report generated by any broker via the Metatrader platform as the input and scapes it for data which is saved in an excel file.  Data science methodologies are then applied to this excel file via python to generate a much better version of the report with data visualizations.",
        "objective": "My objective was to take an autogenerated platform report that is cumbersome to read and doesn't provide any visual representation of the data and turn it into something that is beautified, more legible, and include an enhanced analysis of the data to easily and rapidly tell stories about the trades in a trading account.",
        "challenges": "Honestly, this project wasn't too challenging with a bit of data science and python background. I needed to focus on keeping my code streamlined and reusable to build different data frames and queries across the entire project from one core dataset.", 
        "learned": "Tkinter GUI's and improving on my knowlege of Plotly",
        "languages": ["Python"],
        "liveLink": "",
        "gitLink": "https://github.com/Eric-Lingren/mt4-backtest-analyzer",
        "thumbnailImage" : "https://user-images.githubusercontent.com/44101756/150575636-7e649fd2-042c-4509-b9dc-32e260b871cc.png",
        "images" : [
            "https://user-images.githubusercontent.com/44101756/150453780-43f8cd04-8a2e-448d-94a4-36ab8fda10aa.png",
            "https://user-images.githubusercontent.com/44101756/150453795-50f133f7-4ebe-4308-8be8-0d790e59620d.png",
            "https://user-images.githubusercontent.com/44101756/150453800-1e09e38a-a471-404a-bfb3-cd6f5e596f21.png",
            "https://user-images.githubusercontent.com/44101756/150453235-d1d76668-0624-4f65-aa14-ed78ca454be2.png",
            "https://user-images.githubusercontent.com/44101756/150453242-77d87cdf-59b8-4900-8446-bab71686893c.png",
            "https://user-images.githubusercontent.com/44101756/150452908-a0688987-ffbc-41eb-b185-6e8ffcb3b96c.png",
            "https://user-images.githubusercontent.com/44101756/150453147-099efb59-fcc9-4266-88e5-26110d93b271.png",
        ],
    ...
    {
        "id": 25,
        "title": "Forex Platform & Trading Bots",
        "thumbnailDescription" : "Python robot algorithms and a custom-built broker platform that trade the foreign currency markets via the Oanda REST API.",
